...
namespace Infra.Repositorio
{
    ...
    {
        public Task<IList<UsuarioSistemaFinanceiro>> ListUsuariosSistemaFinanceiro(int IdSistema)
        {
        ...
        public Task RemoveUsuario(List<UsuarioSistemaFinanceiro> usuarios)
        {
            throw new NotImplementedException();
        }
    }
